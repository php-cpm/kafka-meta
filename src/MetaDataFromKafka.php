 ...
 * +------------------------------------------------------------------------------
 *
 * I have no idea whether it is a good idea to use kafka connection to get meta data
 * I feel hard to do so with this one,but zookeeper handler things well
 *
 * I will fix deps in this file later
 *
 * @package
 * @version 0.1.0
 * @copyright Copyleft
...
class MetaDataFromKafka implements \KafkaMeta\ClusterMetaData
{
    // {{{ consts
    // }}}
    // {{{ members
